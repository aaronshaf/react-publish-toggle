...
const UnublishedIcon = React.createClass({
  render() {
    return (
      <div className="ReactPublishButton-unpublished-icon">
        <svg className="ReactPublishButton-unpublished-icon-svg" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
