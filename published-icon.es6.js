...
const PublishedIcon = React.createClass({
  render() {
    return (
      <div className="ReactPublishButton-published-icon">
        <svg className="ReactPublishButton-published-icon-svg" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
