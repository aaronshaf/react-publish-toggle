  ...
  render: function render() {
    ...
    return _React2['default'].createElement(
      ...
      _React2['default'].createElement(
        'svg',
        { className: 'ReactPublishToggle__svg', xmlns: 'http://www.w3.org/2000/svg', width: '32', height: '32', viewBox: '0 0 32 32' },
        _React2['default'].createElement(
          'defs',
          null,
          _React2['default'].createElement(
            'filter',
            { id: 'f2', x: '0', y: '0', width: '200%', height: '200%' },
            _React2['default'].createElement('feOffset', { result: 'offOut', 'in': 'SourceGraphic', dx: '20', dy: '20' }),
            _React2['default'].createElement('feFlood', { 'flood-color': '#3D4574', 'flood-opacity': '0.5', result: 'offsetColor' }),
            _React2['default'].createElement('feGaussianBlur', { result: 'blurOut', 'in': 'offOut', stdDeviation: '10' }),
            _React2['default'].createElement('feBlend', { 'in': 'SourceGraphic', in2: 'blurOut', mode: 'normal' })
          )
        ),
        _React2['default'].createElement('path', { filter: 'url(#f2)', className: 'ReactPublishToggle__cloud',
